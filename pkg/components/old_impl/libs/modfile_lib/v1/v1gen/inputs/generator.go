...
func GenInputs[T model2.Configurable](mfCs map[string]T) map[string]module_lib.Input {
...
func GenInputGroups(mfIGs map[string]model2.InputGroup) map[string]module_lib.InputGroup {
